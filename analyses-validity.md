...
::: {.cell-output-display}
![](analyses-validity_files/figure-html/unnamed-chunk-9-1.png){width=672}
:::
:::
...
::: {.cell-output-display}
![](analyses-validity_files/figure-html/unnamed-chunk-24-1.png){width=672}
:::
:::
...
::: {.cell-output-display}
![](analyses-validity_files/figure-html/unnamed-chunk-48-1.png){width=672}
:::
:::
...
[10] parameters_0.26.0      performance_0.13.0     modelbased_0.10.0     
[13] insight_1.3.0          effectsize_1.0.0       datawizard_1.0.2      
[16] correlation_0.8.7      bayestestR_0.16.0      easystats_0.7.4       
...
[37] Matrix_1.7-3        splines_4.5.0       nnet_7.3-20        
...
[49] evaluate_1.0.3      survival_3.8-3      RcppParallel_5.1.10
[52] pillar_1.10.2       carData_3.0-5       checkmate_2.3.2    
[55] foreach_1.5.2       reformulas_0.4.0    generics_0.1.3     
[58] hms_1.1.3           scales_1.4.0        minqa_1.2.8        
[61] glue_1.8.0          tools_4.5.0         data.table_1.17.0  
[64] lme4_1.1-37         ggsignif_0.6.4      cowplot_1.1.3      
[67] grid_4.5.0          rbibutils_2.3       nlme_3.1-168       
[70] Formula_1.2-5       cli_3.6.5           zigg_0.0.2         
...
[82] mitml_0.4-5         statmod_1.5.0       MASS_7.3-65        
```
